...
print("Plot TSNE and UMAP")
tsne_plot <- DimPlot(tsne_obj, reduction = "tsne") 
tsne_plot + plot_annotation(title = 'DS2 tSNE')
umap_plot <- DimPlot(umap_obj, reduction = "umap") 
umap_plot + plot_annotation(title = 'DS2 UMAP')
...
print("Plot TSNE and UMAP")
tsne_plot <- DimPlot(tsne_obj, reduction = "tsne") 
tsne_plot + plot_annotation(title = 'DS3 tSNE')
umap_plot <- DimPlot(umap_obj, reduction = "umap") 
umap_plot + plot_annotation(title = 'DS3 UMAP')